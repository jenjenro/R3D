...
class Nivel6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnOpcion2 = findViewById<Button>(R.id.btnOp2lv6)
        val btnOpcion3 = findViewById<Button>(R.id.btnOp3lv6)
    ...
    private fun correctQuestion(preguntas: ArrayList<ArrayList<String>> = ArrayList(), index: Int) {
        ...
        val textStatement = findViewById<TextView>(R.id.textStatementlvl6)
        val btnOpcion1 = findViewById<Button>(R.id.btnOp1lv6)
        val btnOpcion2 = findViewById<Button>(R.id.btnOp2lv6)
        val btnOpcion3 = findViewById<Button>(R.id.btnOp3lv6)
